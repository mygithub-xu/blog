...
var constantRouterMap =  [
  ...
  //blog后台--start
  {
    path: '/blog/ht/blogBlog',
    component: resolve => require(['../views/blog/views/ht/blogBlog/blogBlogList.vue'], resolve),
    meta: {
      title: 'blog文章',
      idj: ''
    },
  ...
  {
    path: '/blog/ht/blogProject',
    component: resolve => require(['../views/blog/views/ht/blogProject/blogProjectList.vue'], resolve),
    meta: {
      title: 'blog项目',
      idj: ''
    },
